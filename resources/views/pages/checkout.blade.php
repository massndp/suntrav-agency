        ...
        <div class="row">
                   ...
                   <tr>
                    ...
                    <td class="align-middle">
                      <a href="{{route('checkout-remove', $detail->id)}}">
                        <img src="{{url('frontend/images/close@2x.png')}}" alt="" />
                      </a>
                    </td>
                  </tr>
                   @empty
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <h2 class="tripinfo">Trip Information</h2>
              ...
              Please complate payment before continue the trip
              </p>

              <div class="bank">
                <div class="bank-item pb-3">
                  <img
                    src="{{url('frontend/images/bank.png')}}"
                    alt=""
                    class="bank-image"
                  />
